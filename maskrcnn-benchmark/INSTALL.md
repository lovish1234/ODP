...
pip install ninja yacs cython matplotlib tqdm opencv-python h5py
...
# We modified the coco api to deal with is_crowd and colorization of predictions
git clone https://github.com/AtlantixJJ/cocoapi.git
